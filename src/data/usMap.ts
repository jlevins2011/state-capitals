/* CC0 public-domain US state outlines.
 * Source: Wikimedia Commons "Blank US Map (states only).svg" by Heitordp
 * https://commons.wikimedia.org/wiki/File:Blank_US_Map_(states_only).svg
 * ViewBox 0 0 959 593 (Albers). Alaska inset at reduced scale; Hawaii inset.
 */
export const MAP_VIEWBOX = "0 0 959 593";
...
export const STATE_PATH_BY_ID: Record<string, string> = Object.fromEntries(
  STATE_PATHS.map((p) => [p.id, p.d]),
);
...
export const REGION_VIEWS: Record<string, string> = {
  all: "0 0 959 593",
  northeast: "710 12 245 280",
  southeast: "480 200 390 400",
  midwest: "326 28 430 340",
  southwest: "110 270 440 325",
  west: "0 8 420 575",
};

export const SMALL_STATES = new Set(["RI", "DE", "CT", "NJ", "DC", "HI", "VT", "NH", "MD"]);
