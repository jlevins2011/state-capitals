  ...
  return (
    <div className="screen map-screen">
      <header className="map-top">
        ...
        <div className="map-who">
          ...
          <div>
            ...
            <p>
              {progressPercent(child)}% lit · {totalStars(child)}/{maxStars()} stars · {child.factsFound.length} facts
            </p>
          </div>
        </div>
        <button
      ...
      <div className="map-preview panel">
        <UsaMap regionId="all" showLabels litIds={Object.keys(child.completedLessons)} />
      </div>
